...
describe("Debug Presenter", () => {
  ...
  it("parses dynamic info from an array of chronicle values", () => {
    ...
    const expectedObject = {
      static: [],
      dynamic: ["2018-02-07T15:49:18.259Z - Info: A string info message"],
    }
  ...
  it("parses events to readable representation", () => {
    presenter.update([{ type: "event", event: { state: MediaState.PLAYING }, timestamp: 1518018558259 }])
    const expectedObject = {
      static: [],
      dynamic: ["2018-02-07T15:49:18.259Z - Event: PLAYING"],
    }
  ...
  it("parses time to formatted string representation", () => {
    presenter.update([{ type: "time", currentTime: 12.3433, timestamp: 1518018558259 }])
    const expectedObject = {
      static: [],
      dynamic: ["2018-02-07T15:49:18.259Z - Video time: 12.34"],
    }
  ...
  it("parses long time to formatted string representation", () => {
    presenter.update([{ type: "time", currentTime: 788.9999, timestamp: 1518018558259 }])
    const expectedObject = {
      static: [],
      dynamic: ["2018-02-07T15:49:18.259Z - Video time: 789.00"],
    }
  ...
  it("parses apicall to a formatted string representation", () => {
    presenter.update([{ type: "apicall", calltype: "Play", timestamp: 1518018558259 }])
    const expectedObject = {
      static: [],
      dynamic: ["2018-02-07T15:49:18.259Z - Api call: Play"],
    }
  ...
  it("When the log object does not contain a valid type", () => {
    presenter.update([{ type: "blah", someobject: { thing: "" }, timestamp: 1518018558259 }])
    const expectedObject = {
      static: [],
      dynamic: ["2018-02-07T15:49:18.259Z - Unknown log format"],
    }
