...
import PlayerComponent from '../script/playercomponent';
...
import MockBigscreenPlayer from '../script/mockbigscreenplayer';
...
import SlidingWindowUtils from '../script/utils/timeutils';
import callCallbacks from '../script/utils/callcallbacks';
import MediaSources from '../script/mediasources';
import Version from '../script/version';
import Resizer from '../script/resizer';
import ReadyHelper from '../script/readyhelper';
import Subtitles from '../script/subtitles/subtitles';
