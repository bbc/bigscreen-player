...
describe("Native Strategy", () => {
  ...
  describe("window types", () => {
    it("calls LegacyAdapter with a static media player when called for STATIC window", () => {
      NativeStrategy(mediaSources, mediaKind, playbackElement, isUHD)

      expect(HTML5Player).toHaveBeenCalledWith()

      expect(LegacyAdapter).toHaveBeenCalled()
      expect(LegacyAdapter).toHaveBeenCalledWith(mediaSources, playbackElement, isUHD, html5Player)
    })
    ...
    it("calls LegacyAdapter with a live media player when called for a GROWING window", () => {
      ...
      expect(HTML5Player).toHaveBeenCalledWith()
      expect(Playable).toHaveBeenCalledWith(html5Player, mediaSources)

      expect(LegacyAdapter).toHaveBeenCalledWith(mediaSources, playbackElement, isUHD, playablePlayer)
    })
  ...
  describe("players", () => {
    ...
    it("should use the cehtml when configured", () => {
      ...
      expect(LegacyAdapter).toHaveBeenCalledWith(mediaSources, playbackElement, isUHD, cehtmlPlayer)
    })
    ...
    it("should use the samsungmaple when configured", () => {
      ...
      expect(LegacyAdapter).toHaveBeenCalledWith(mediaSources, playbackElement, isUHD, samsungMaplePlayer)
    })
    ...
    it("should use the samsungstreaming when configured", () => {
      ...
      expect(LegacyAdapter).toHaveBeenCalledWith(mediaSources, playbackElement, isUHD, samsungStreamingPlayer)
    })
    ...
    it("should use the samsungstreaming2015 when configured", () => {
      ...
      expect(LegacyAdapter).toHaveBeenCalledWith(mediaSources, playbackElement, isUHD, samsungStreaming2015Player)
    })
  })
  ...
  describe("live players", () => {
    ...
    it("should use none when configured", () => {
      ...
      expect(None).toHaveBeenCalledWith(html5Player, mediaSources)
      expect(LegacyAdapter).toHaveBeenCalledWith(mediaSources, playbackElement, isUHD, nonePlayer)
    })
    ...
    it("should use restartable when configured", () => {
      ...
      expect(RestartablePlayer).toHaveBeenCalledWith(html5Player, mediaSources)
      expect(LegacyAdapter).toHaveBeenCalledWith(mediaSources, playbackElement, isUHD, restartablePlayer)
    })
    ...
    it("should use seekable when configured", () => {
      ...
      expect(SeekablePlayer).toHaveBeenCalledWith(html5Player, mediaSources)
      expect(LegacyAdapter).toHaveBeenCalledWith(mediaSources, playbackElement, isUHD, seekablePlayer)
    })
  })
})
