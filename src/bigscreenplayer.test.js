...
function initialiseBigscreenPlayer(options = {}) {
  ...
  const { windowStartTime, windowEndTime } = options
  ...
  const { subtitlesAvailable } = options
...
describe("Bigscreen Player", () => {
  ...
  describe("init", () => {
    it("should set endOfStream to true when playing live and no initial playback time is set", () => {
      ...
      bigscreenPlayer = initialiseBigscreenPlayer({ windowType: WindowTypes.SLIDING })
    ...
    it("should set endOfStream to false when playing live and initialPlaybackTime is 0", () => {
      ...
      bigscreenPlayer = initialiseBigscreenPlayer({ windowType: WindowTypes.SLIDING, initialPlaybackTime: 0 })
    ...
    it("should not attempt to call onSuccess callback if one is not provided", () => {
      ...
      bigscreenPlayer = initialiseBigscreenPlayer()
  ...
  describe("player ready callback", () => {
    describe("on state change event", () => {
      ...
      it("should be called if playing VOD with an initial start time and event time is valid", () => {
        bigscreenPlayer = initialiseBigscreenPlayer({ initialPlaybackTime: 20 })
  ...
  describe("setCurrentTime", () => {
    ...
    it("should not set the current time if media is not mounted", () => {
      forceMediaSourcesConstructionFailure = true
      bigscreenPlayer = initialiseBigscreenPlayer()
      bigscreenPlayer = bigscreenPlayer.setCurrentTime(60)
  ...
  describe("Playback Rate", () => {
    ...
    it("should not set playback rate if playback component is not initialised", () => {
      forceMediaSourcesConstructionFailure = true
      bigscreenPlayer = initialiseBigscreenPlayer()
      bigscreenPlayer = bigscreenPlayer.setPlaybackRate(2)
    ...
    it("does not get playback rate if playback component is not initialised", () => {
      forceMediaSourcesConstructionFailure = true
      bigscreenPlayer = initialiseBigscreenPlayer()
      bigscreenPlayer = bigscreenPlayer.getPlaybackRate()
  ...
  describe("getCurrentTime", () => {
    ...
    it("returns `0` if media is not mounted", () => {
      forceMediaSourcesConstructionFailure = true
      bigscreenPlayer = initialiseBigscreenPlayer()
  ...
  describe("getMediaKind", () => {
    it("should return the media kind", () => {
      bigscreenPlayer = initialiseBigscreenPlayer({ mediaKind: "audio" })
  ...
  describe("getSeekableRange", () => {
    ...
    it("returns `{}` if media is not mounted", () => {
      forceMediaSourcesConstructionFailure = true
      bigscreenPlayer = initialiseBigscreenPlayer()
  ...
  describe("isAtLiveEdge", () => {
    ...
    it("returns `false` if media is not mounted", () => {
      forceMediaSourcesConstructionFailure = true
      bigscreenPlayer = initialiseBigscreenPlayer()
      bigscreenPlayer = expect(bigscreenPlayer.isPlayingAtLiveEdge()).toBe(false)
    })
  ...
  describe("getLiveWindowData", () => {
    it("should return undefined values when windowType is static", () => {
      bigscreenPlayer = initialiseBigscreenPlayer({ windowType: WindowTypes.STATIC })
    ...
    it("should return liveWindowData when the windowType is sliding and manifest is loaded", () => {
      ...
      bigscreenPlayer = initialiseBigscreenPlayer(initialisationData)
  ...
  describe("getDuration", () => {
    ...
    it("returns `undefined` if media is not mounted", () => {
      forceMediaSourcesConstructionFailure = true
      bigscreenPlayer = initialiseBigscreenPlayer()
  ...
  describe("isPaused", () => {
    ...
    it("returns `true` if media is not mounted", () => {
      forceMediaSourcesConstructionFailure = true
      bigscreenPlayer = initialiseBigscreenPlayer()
      expect(bigscreenPlayer.isPaused()).toBe(true)
    })
  ...
  describe("play", () => {
    it("should call play on the strategy", () => {
      ...
      bigscreenPlayer = bigscreenPlayer.play()
