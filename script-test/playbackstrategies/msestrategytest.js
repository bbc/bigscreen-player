    ...
    describe('Media Source Extensions Playback Strategy', function () {
      ...
      describe('Load', function () {
        ...
        it('should initialise MediaPlayer with the expected parameters when startTime is set and there is a time correction', function () {
          ...
          expect(mockDashInstance.initialize).toHaveBeenCalledWith(mockVideoElement, null, true);
          expect(mockDashInstance.retrieveManifest).toHaveBeenCalledWith('src#t=1937', jasmine.any(Function));
        });
        ...
        it('should attach a new source when CDN Failover occurs', function () {
          ...
          expect(mockDashInstance.retrieveManifest).toHaveBeenCalledWith('src2#t=0', jasmine.any(Function));
        });
        ...
        it('should playback from relative live start time for video simulcast', function () {
          ...
          expect(mockDashInstance.initialize).toHaveBeenCalledWith(mockVideoElement, null, true);
          expect(mockDashInstance.retrieveManifest).toHaveBeenCalledWith('src#r=-1', jasmine.any(Function));
        });
      ...
      describe('alterManifest()', function () {
        var manifest;
        ...
        it('should leave the manifest unchanged', function () {
          var actualManifest = mseStrategy.alterManifest(manifest, {});
        ...
        it('should remove representations with a higher frame rate than the max', function () {
          ...
          var actualManifest = mseStrategy.alterManifest(manifest, {maxFps: 30});
        ...
        it('should remove representations that are lower than the highest if constantFps is set', function () {
          ...
          var actualManifest = mseStrategy.alterManifest(manifest, {constantFps: true});
        ...
        it('should only keep the highest framerate that is not higher than max', function () {
          ...
          var actualManifest = mseStrategy.alterManifest(manifest, {constantFps: true, maxFps: 30});
