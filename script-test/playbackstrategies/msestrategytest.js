    ...
    function (Squire, MediaKinds, WindowTypes) {
      describe('Media Source Extensions Playback Strategy', function () {
        ...
        describe('Transitions', function () {
          ...
          it('should create an audio element and add it to the video container', function () {
        ...
        describe('Load', function () {
          ...
          it('should attach a new audio source when CDN Failover occurs', function () {
            setUpMSE(null, null, MediaKinds.AUDIO);
          ...
          it('should playback from relative live start time for audio simulcast', function () {
            setUpMSE(0, WindowTypes.SLIDING, MediaKinds.AUDIO);
          ...
          it('should playback from relative start time for audio simulcast', function () {
            setUpMSE(0, WindowTypes.SLIDING, MediaKinds.AUDIO);
          ...
          it('returns the correct duration from the DASH Mediaplayer with audio', function () {
            setUpMSE(null, null, MediaKinds.AUDIO);
          ...
          it('returns the correct duration from the DASH Mediaplayer with video', function () {
            setUpMSE();
        ...
        describe('getSeekableRange()', function () {
          it('returns the correct start and end time video', function () {
            setUpMSE();
            mseStrategy.load('src', null, 45);
          ...
          it('returns the correct start and end time for audio', function () {
            setUpMSE(null, null, MediaKinds.AUDIO);
            mseStrategy.load('src', null, 45);
